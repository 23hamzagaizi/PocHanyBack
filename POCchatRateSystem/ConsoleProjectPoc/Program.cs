...
namespace ConsoleProjectPoc
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Process.Start("ConsoleProjectPoc.exe");
            }
        ...
        public static async Task StartWebSockets()
        {
            ...
            var send = Task.Run(async () =>
            {
                ...
                while ((message = Console.ReadLine()) != null && message != string.Empty)
                {
                    ...
                    await client.SendAsync(new ArraySegment<byte>(), WebSocketMessageType.Text, true, CancellationToken.None);
